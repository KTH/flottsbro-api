...
apiRoute.register(
  paths.api.addLatestForApplicationName,
  Deployments.addLatestForApplicationName
);
apiRoute.register(
...
apiRoute.register(
  paths.api.deleteApplicationName,
  Deployments.deleteApplicationName
);
apiRoute.register(paths.api.getLatestBySearch, Deployments.getLatestBySearch);
